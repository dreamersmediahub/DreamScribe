...
class WindowManager: NSObject {
    ...
    private static let mainWindowIdentifier = NSUserInterfaceItemIdentifier("co.dreamersmedia.dreamscribe.mainWindow")
    private static let onboardingWindowIdentifier = NSUserInterfaceItemIdentifier("co.dreamersmedia.dreamscribe.onboardingWindow")
    private static let mainWindowAutosaveName = NSWindow.FrameAutosaveName("DreamScribeMainWindowFrame")

    private let logger = Logger(subsystem: "co.dreamersmedia.dreamscribe", category: "WindowManager")
    ...
    func configureOnboardingPanel(_ window: NSWindow) {
        ...
        window.title = "DreamScribe Onboarding"
