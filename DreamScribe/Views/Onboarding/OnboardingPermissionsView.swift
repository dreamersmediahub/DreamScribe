...
struct OnboardingPermissionsView: View {
    ...
    private let permissions: [OnboardingPermission] = [
        ...
        OnboardingPermission(
            ...
            description: "Select the audio input device you want to use with DreamScribe.",
            icon: "headphones",
            type: .audioDeviceSelection
        ),
        OnboardingPermission(
            title: "Accessibility Access",
            description: "Allow DreamScribe to help you type anywhere in your Mac.",
            icon: "accessibility",
            type: .accessibility
        ),
        OnboardingPermission(
        ...
        OnboardingPermission(
            ...
            description: "Set up a keyboard shortcut to quickly access DreamScribe from anywhere.",
            icon: "keyboard",
                            ...
                            VStack(spacing: 12) {
                                HStack(spacing: 8) {
                                    ...
                                    if permissions[currentPermissionIndex].type == .screenRecording {
                                        InfoTip(
                                            "DreamScribe captures on-screen text to understand the context of your voice input, which significantly improves transcription accuracy. Your privacy is important: this data is processed locally and is not stored.",
