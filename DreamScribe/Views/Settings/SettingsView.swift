    ...
    var body: some View {
        Form {
            ...
            Section("Recording Feedback") {
                ...
                // Restore Clipboard — DreamScribe always keeps the transcript
                // on the clipboard, so this toggle is hidden in LOCAL_BUILD.
                #if !LOCAL_BUILD
                ExpandableSettingsRow(
            ...
            Section {
                ...
                Text("Control how DreamScribe handles your transcription data and audio recordings.")
            }
