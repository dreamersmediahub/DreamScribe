...
class HotkeyManager: ObservableObject {
    ...
    private let logger = Logger(subsystem: "co.dreamersmedia.dreamscribe", category: "HotkeyManager")
    ...
    init(engine: DreamScribeEngine, recorderUIManager: RecorderUIManager) {
