...
class Recorder: NSObject, ObservableObject {
    ...
    private let logger = Logger(subsystem: "co.dreamersmedia.dreamscribe", category: "Recorder")
    ...
    private let audioMeterQueue = DispatchQueue(label: "co.dreamersmedia.dreamscribe.audiometer", qos: .userInteractive)
    /// Dedicated serial queue for hardware setup.
    private let audioSetupQueue = DispatchQueue(label: "co.dreamersmedia.dreamscribe.audioSetup", qos: .userInitiated)
