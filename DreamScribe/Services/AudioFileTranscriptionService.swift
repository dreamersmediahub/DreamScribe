...
class AudioTranscriptionService: ObservableObject {
    ...
    private let logger = Logger(subsystem: "co.dreamersmedia.dreamscribe", category: "AudioTranscriptionService")
    ...
    init(modelContext: ModelContext, engine: DreamScribeEngine) {
