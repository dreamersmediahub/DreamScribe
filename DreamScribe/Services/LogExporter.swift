...
final class LogExporter {
    ...
    private let logger = Logger(subsystem: "co.dreamersmedia.dreamscribe", category: "LogExporter")
    private let subsystem = "co.dreamersmedia.dreamscribe"
    ...
    private func fetchLogs() async throws -> [String] {
        ...
        logLines.append("=== DreamScribe Diagnostic Logs ===")
    ...
    private func saveLogsToFile(_ logs: [String]) throws -> URL {
        ...
        let fileName = "DreamScribe_Logs_\(timestamp).log"
