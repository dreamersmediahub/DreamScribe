...
class AudioTranscriptionManager: ObservableObject {
    ...
    private let logger = Logger(subsystem: "co.dreamersmedia.dreamscribe", category: "AudioTranscriptionManager")
    ...
    func startProcessing(modelContext: ModelContext, engine: DreamScribeEngine) {
    ...
    private func processItem(_ item: AudioFileQueueItem, modelContext: ModelContext, engine: DreamScribeEngine) async {
