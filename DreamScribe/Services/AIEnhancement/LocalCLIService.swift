...
final class LocalCLIService {
    ...
    private static let shellPathQueue = DispatchQueue(label: "co.dreamersmedia.dreamscribe.localcli.path")
    ...
    private static func discoverPATHFromInteractiveLoginShell() -> String? {
        ...
        process.arguments = [
            "-ilc",
            "echo __DREAMSCRIBE_PATH_START__; print -r -- $PATH; echo __DREAMSCRIBE_PATH_END__"
        ]
        ...
        let startMarker = "__DREAMSCRIBE_PATH_START__"
        let endMarker = "__DREAMSCRIBE_PATH_END__"
