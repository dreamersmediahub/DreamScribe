...
class MenuBarManager: ObservableObject {
    private let logger = Logger(subsystem: "co.dreamersmedia.dreamscribe", category: "MenuBarManager")
    ...
    private var engine: DreamScribeEngine?
    ...
    func configure(modelContainer: ModelContainer, engine: DreamScribeEngine) {
