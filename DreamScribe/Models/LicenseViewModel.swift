...
class LicenseViewModel: ObservableObject {
    ...
    private let logger = Logger(subsystem: "co.dreamersmedia.dreamscribe", category: "LicenseViewModel")
    ...
    private func loadLicenseState() {
        ...
        // Read new key first; fall back to legacy VoiceInk key for upgrade-from-old-version, then migrate.
        let newKey = "DreamScribeHasLaunchedBefore"
        let legacyKey = "VoiceInkHasLaunchedBefore"
    ...
    func removeLicense() {
        ...
        userDefaults.set(false, forKey: "VoiceInkLicenseRequiresActivation")
        userDefaults.set(false, forKey: "DreamScribeHasLaunchedBefore")  // Allow trial to restart
        userDefaults.removeObject(forKey: "VoiceInkHasLaunchedBefore")  // Clear legacy key
